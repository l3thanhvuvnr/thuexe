...
( function() {
	...
	jQuery( document ).ready( function() {
		...
		// Rotating Text Child Element View.
		FusionPageBuilder.iee_rotating_text_child = FusionPageBuilder.ChildElementView.extend( {
			...
			afterPatch: function() {
				...
				setTimeout( function() {
					jQuery( '#fb-preview' )[ 0 ].contentWindow.jQuery( 'body' ).trigger( 'fusion-element-render-iee_rotating_text', parentCid );
				}, 200 );
			...
			filterTemplateAtts: function( atts ) {
				...
				this.parentValues = jQuery.extend( true, {}, fusionAllElements.iee_rotating_text.defaults, _.fusionCleanParameters( parentModel.get( 'params' ) ) );
