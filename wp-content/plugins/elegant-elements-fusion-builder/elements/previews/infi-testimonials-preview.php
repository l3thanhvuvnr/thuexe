<script type="text/template" id="elegant-elements-module-infi-testimonials-preview-template">
	...
	<ul>
		...
		shortcode_reg_exp = window.wp.shortcode.regexp( 'iee_testimonial' ),
		shortcode_inner_reg_exp = new RegExp( '\\[(\\[?)(iee_testimonial)(?![\\w-])([^\\]\\/]*(?:\\/(?!\\])[^\\]\\/]*)*?)(?:(\\/)\\]|\\](?:([^\\[]*(?:\\[(?!\\/\\2\\])[^\\[]*)*)(\\[\\/\\2\\]))?)(\\]?)' ),
