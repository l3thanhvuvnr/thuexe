<script type="text/template" id="elegant-elements-module-infi-typewriter-text-preview-template">
	...
	<ul>
		...
		shortcode_reg_exp = window.wp.shortcode.regexp( 'iee_typewriter_text_child' ),
		shortcode_inner_reg_exp = new RegExp( '\\[(\\[?)(iee_typewriter_text_child)(?![\\w-])([^\\]\\/]*(?:\\/(?!\\])[^\\]\\/]*)*?)(?:(\\/)\\]|\\](?:([^\\[]*(?:\\[(?!\\/\\2\\])[^\\[]*)*)(\\[\\/\\2\\]))?)(\\]?)' ),
